...
public class PokerExample {
    ...
    private static final Logger LOG = LoggerFactory.getLogger( PokerExample.class );
    private static final boolean PRINT_DRL = true;

    public static void main( String... args ) throws Exception {

        String inputFile = System.getProperty( "user.dir" ) + "/src/main/resources/data/poker/poker.training.data.csv";
